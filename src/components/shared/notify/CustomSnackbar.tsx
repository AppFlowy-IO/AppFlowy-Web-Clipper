...
const CustomSnackbar = React.forwardRef<HTMLDivElement, CustomContentProps>(
  (props, ref) => {
    ...
    const icons = {
      success: <TaskAltRounded className='h-6 w-6 text-green-500' />,
      error: <HighlightOff className='h-6 w-6 text-red-500' />,
      warning: <ErrorOutline className='h-6 w-6 text-yellow-500' />,
      info: <PowerSettingsNew className='h-6 w-6 text-blue-500' />,
      default: null,
    };
      ...
      >
        <div className='flex items-center p-4'>
          ...
          <button
            ...
            className='ml-4 text-gray-400 hover:text-gray-500 focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2'
          >
